    ...
    for layer_x in 0..params.layer_width {
      ...
      for neuron_in_field_y in 0..params.field_height {
        for neuron_in_field_x in 0..params.field_width {
          ...
          accumulated_weights_1_to_2[[neuron_index, neuron_index]] = synapse_params.initial_strong_g;
          accumulated_weights_2_to_1[[neuron_2_to_1_index, neuron_index]] = synapse_params.initial_strong_g;

          let (x, y) = get_neuron_coordinates(params, layer_x, layer_y, neuron_in_field_x, neuron_in_field_y);

          apply_mask(params, computed_params, neuron_index, &mut distance_weights_1_to_2, mask, x, y);

          let (x_2_to_1, y_2_to_1) = get_neuron_coordinates(params, layer_2_to_1_x, layer_2_to_1_y, neuron_in_field_x, neuron_in_field_y);

          apply_mask(params, computed_params, neuron_index, &mut distance_weights_2_to_1, mask, x_2_to_1, y_2_to_1);
        }
      }
    }
  }
